...
const CardEditorPage = (props: CardEditorPageProps) => {
  ...
  const onCardSet = (card: CardData) => {
    const exportingAllCards: string | undefined = Cookies.get(
      MultitaskCookie.EXPORTING_ALL_CARDS
    );
    const exportingAllIndex: string | undefined = Cookies.get(
      MultitaskCookie.EXPORTING_ALL_INDEX
    );
